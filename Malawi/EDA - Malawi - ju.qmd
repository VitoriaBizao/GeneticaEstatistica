...
```{r message=FALSE, warning=FALSE}
# fitrando os ensaios selecionados:
...
# %in% : selecione todas as linhas onde env é igual a qualquer um desses quatro ensaios

table(dat_sub$rep, dat_sub$gen) # todos os genótipos aparecem 4 vezes em cada repetição, ou seja, escolhemos certo! Sem dados faltantes!
